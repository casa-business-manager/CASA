...
public class RoleController {
	...
	// PUT (ASSIGN/REMOVE) roles for user
	...
	public ResponseEntity<?> createRole(@RequestBody String orgId, @RequestBody RoleDto newRoleData) {
		Organization org = organizationRepository.findById(orgId)
				.orElseThrow(() -> new RuntimeException("Organization could not found with org id: " + orgId));
	...
	public ResponseEntity<?> editRole(@RequestBody String roleId, @RequestBody RoleDto newRoleData) {
	...
	public ResponseEntity<?> addRoleToUser(@RequestBody String userId, @RequestBody String roleId,
			@RequestBody RoleDto newRoleData) {
	...
	public ResponseEntity<?> removeRoleFromUser(@RequestBody String userId, @RequestBody String roleId,
			@RequestBody RoleDto newRoleData) {
		User user = userRepository.findById(userId)
				.orElseThrow(() -> new RuntimeException("User could not found with user id: " + userId));
